  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <p>You can go on this link to check the Smart Contract on the blockchain: <Link to="https://ropsten.etherscan.io/address/0x03489e112b65C091d1b697A9cCc2053Aad4c3760">Contract Ropsten Blockchain</Link></p>
